defmodule BotArmyMediaIngestion.Skills.Example do
  @moduledoc """
  Example skill for Media Ingestion Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_media_ingestion.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_media_ingestion.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_media_ingestion/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_media_ingestion.command.example"
    ]
  end
