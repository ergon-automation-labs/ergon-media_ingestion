...
compile:
	@LOG_FILE="/tmp/compile-ingestion-$$(date +%s).log"; \
	echo "Compiling ingestion and logging to $$LOG_FILE..."; \
...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/media_ingestion_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/media_ingestion_bot/"
	@echo ""
...
publish-release: release
	...
	gh release create v$$VERSION media_ingestion_bot-$$VERSION.tar.gz \
		...
		--notes "Media Ingestion Bot Elixir release v$$VERSION. Download and deploy with Jenkins." \
		--draft=false; \
